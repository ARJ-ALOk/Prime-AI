...
OPENROUTER_API_KEY = (
    ...
    or os.getenv("OPENROUTER_API_TOKEN")
    or os.getenv("OPENROUTER_KEY")
)
OPENROUTER_URL = os.getenv("OPENROUTER_URL", "https://openrouter.ai/api/v1/chat/completions")
MODEL = os.getenv("OPENROUTER_MODEL", "arcee-ai/trinity-large-preview:free")
PROMPT_PATH = os.getenv("JARVIS_PROMPT_PATH", "core/prompt.txt")
...
def load_system_prompt() -> str:
    try:
        ...
        print(f"prompt.txt cannot be loaded: {e}")
...
def get_llm_output(user_text: str, memory_block: dict | None = None) -> dict:
    ...
    if not OPENROUTER_API_KEY:
        print("OPENROUTER_API_KEY was not found.")
        return {
            "intent": "chat",
            "parameters": {},
